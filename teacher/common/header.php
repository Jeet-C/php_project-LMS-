        ...
        <div class="col-lg-7 col-md-6 col-sm-7 col-7">
            ...
            <div class="logo-block">
                <a href="index.html" class="logo">
                    <img src="img/logo.svg" alt="Admin Panel Website Templates" />
                </a>
            ...
            <ul class="header-actions">
                ...
                <li class="dropdown">
                    <a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
                        <span class="avatar"><?php echo $_SESSION['us'][0];  ?><span class="status online"></span></span>
                        
                        <span class="user-name"><?php echo $_SESSION['us'];?></span>
