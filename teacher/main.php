...
<html lang="en">
  ...
  ?>
    ...
    <tbody>
		<?php
		$id = $_SESSION['id'];
		$see="SELECT * FROM ggi WHERE user_id='$id'";
		$r=$con->query($see);
      ...
      <tr>
		...
		<td><img class="pdf" src="img/pdf.png"><?php echo $row['pdf'];?></td>
		<td><a href="../pdf/<?php echo $row['pdf']; ?>" class="btn btn-success">View</a></td>
		<td><a href="edit.php?eid=<?php echo $row['gid']; ?>" class="btn btn-primary">Edit</a></td>
		<td><a href="delete.php?del=<?php echo $row['gid']; ?>" class="btn btn-danger">Delete</a></td>
      </tr>
	  <?php } ?>
    </tbody>
  </table>
